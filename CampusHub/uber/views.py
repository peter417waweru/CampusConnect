...
def view_requests(request):
   uber_requests = UberRequest.objects.filter(status='requested').order_by('-created_at')
   return render(request, 'uber/drivers/view_request.html', {'uber_requests': uber_requests})
...
def record_trip(request):
    ...
    context = {'form': form}
    return render(request, 'uber/drivers/earning_dashboard.html', context)
